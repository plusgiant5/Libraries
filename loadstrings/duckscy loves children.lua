...
function onRunning(speed, reading)
	if IsReading() and not reading then return end
	if speed > 0.01 then
...
function onClimbing(speed, reading)
	if IsReading() and not reading then return end
...
function onFreeFall()
	if IsReading() and Humanoid.FloorMaterial ~= Enum.Material.Air then return end
